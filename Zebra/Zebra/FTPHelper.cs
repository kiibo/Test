...
namespace Zebra
{
    public class FTPHelper
    {
        ...
        #region  上传文件到FTP Server
        /// <summary>
        /// 上传文件到FTP Server
        /// </summary>
        /// <param name="UpLoadUri">把上传的文件保存为ftp服务器文件的uri,如"ftp://192.168.1.104/capture-212.avi"</param>
        ...
        public void DownLoadFile(string downloadUrl,string saveFileUrl)
        {
            ...
            {
                throw new Exception("从ftp server 下载文件出错，文件名" + downloadUrl + "异常信息：" + ex.ToString());
            }
            finally
            {
                if (reader != null)
        ...
        //drwxrwxrwx    4 0        501          4096 Aug 17 16:56 pub\r\n
